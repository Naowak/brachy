...
def test_2():
    ...
    dose_path = path_dir + "src/tests/data_tests/my_head_dose.dat"
    f = open(dose_path, "r")
...
def test_3():
    ...
    DICOM_path = path_dir + "src/tests/data_tests/prostate"
    RT_structure_id = 158
...
def test_8():
    ...
    filename_head = path_dir + "src/tests/data_tests/resultats_prostate/prostate"
